...
//		clone.other_matched_points = other_matched_points;
	...
	public boolean hasBothImages(){
		return !(reference_image == null || other_image == null 
	            || reference_keyPoint == null || other_keyPoint == null
				|| reference_Descriptors == null || other_Descriptors == null);
	}
...
//		other_KPImage = null;
	...
	/**
	 * @return whether a homography matrix exists
	 */
	public boolean hasHomography(){
	...
	public MatOfDMatch getPutativeMatches(){
	...
	public MatOfKeyPoint getReferenceKeyPoints(){
		return reference_keyPoint == null ? null : reference_keyPoint;
	}
	...
	public MatOfKeyPoint getOtherKeyPoints(){
		return other_keyPoint == null ? null : other_keyPoint;
	}
	 ...
	 */
	public Mat getMatchImage(ComputerVision cv){
		if (matches == null || reference_image == null || 
				other_image == null || reference_keyPoint == null 
				|| other_keyPoint == null)
		return null;
		if (cv == null)
			throw new IllegalStateException("Compuer Vision not initialized");
		Scalar red = new Scalar(255,0,0);
		Scalar green = new Scalar(0,255,0);
		
		return cv.getMatchesImage(reference_image, reference_keyPoint, other_image,
				other_keyPoint, matches, green, red, null);
	}
	
	public Mat getReferenceDescriptors(){
		return reference_Descriptors == null ? null : reference_Descriptors.clone();
	}
	
	public Mat getOtherDescriptors(){
		return other_Descriptors == null ? null : other_Descriptors.clone();
	}
