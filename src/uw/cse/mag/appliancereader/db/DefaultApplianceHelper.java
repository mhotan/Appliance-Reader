...
public class DefaultApplianceHelper extends SQLiteOpenHelper {

	public static final String TABLE_APPLIANCE = "defaultappliances";
	 ...
	 * @param ctx
	 */
	public DefaultApplianceHelper(Context ctx) {
	...
	public void onCreate(SQLiteDatabase database) {
		...
		database.execSQL(UserApplianceHelper.DATABASE_CREATE);
	}
